...
def train(model, loader):
    ...
    print("trainSam..", len(loader.trainSamples))
    print('batchsize', Model.batchSize)
...
def infer(model, fnImg):
    ...
    # print("Printing..", recognized)
    print("Without spell Correction .....", recognized[0])
    print("With spell Correction ....", correct_sentence(recognized[0]))
    return recognized[0]
